...
func _physics_process(delta):
	...
	var move_input = Input.get_axis("p1_accelerate", "p1_brake")
	var rotate_input = Input.get_axis("p1_right", "p1_left")
...
func set_sprite_sink():
	if car_sprite:
		car_sprite.texture = particle_texture# Ganti path sesuai asset
